...
function populateTestFees() {
  ...
  testRelayerFees.fees[gatewayDb.TransactionType.ProxyBond] = DEFAULT_RELAYER_FEE;
  testRelayerFees.fees[gatewayDb.TransactionType.ProxyNominate] = DEFAULT_RELAYER_FEE;

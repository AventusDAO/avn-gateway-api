...
import { PollResult, TxNotFoundResult, PollErrorResult, AccountInfo, UnprocessedLifts, EthereumEventStatus, NftInfo, BatchInfo,
  GatewayUserInfo, PayerInfo, SuccessResponse, TotalToken, LowerData
 } from './types';
...
app.get('/health', async (req: Request, res: Response<SuccessResponse<null>>, next: NextFunction) => {
  try {
...
app.post('/avnQuery', async (req: Request, res: Response<SuccessResponse<string>>, next: NextFunction) => {
  try {
...
app.post('/avnPoll', async (req: Request, res: Response<SuccessResponse<PollResult | TxNotFoundResult | PollErrorResult>>, next: NextFunction) => {
  try {
...
app.get('/pendingTransactions', async (req: Request, res: Response<SuccessResponse<string[]>>, next: NextFunction) => {
  try {
...
app.post('/relayerFees', async (req: Request, res: Response<SuccessResponse<string | Record<string, string>>>, next: NextFunction) => {
  try {
...
app.post('/avnAccountInfo', async (req: Request, res: Response<SuccessResponse<AccountInfo>>, next: NextFunction) => {
  try {
...
app.post('/avnValidatorsToNominate', async (req: Request, res: Response<SuccessResponse<string>>, next: NextFunction) => {
  try {
...
app.post('/avnStakingStats', async (req: Request, res: Response<SuccessResponse<string>>, next: NextFunction) => {
  try {
...
app.post('/avnChainInfo', async (req: Request, res: Response<SuccessResponse<string>>, next: NextFunction) => {
  try {
...
app.post('/avnCurrentBlock', async (req: Request, res: Response<SuccessResponse<string>>, next: NextFunction) => {
  try {
...
app.post('/getDefaultRelayer', async (req: Request, res: Response<SuccessResponse<string>>, next: NextFunction) => {
  try {
...
app.get('/unprocessedLifts', async (req: Request, res: Response<SuccessResponse<UnprocessedLifts>>, next: NextFunction) => {
  try {
...
app.get('/autolower', async (req: Request, res: Response<SuccessResponse<string>>, next: NextFunction) => {
  try {
...
app.post('/ethereumEventStatus', async (req: Request, res: Response<SuccessResponse<EthereumEventStatus>>, next: NextFunction) => {
  try {
...
app.post('/avnTotalToken', async (req: Request, res: Response<SuccessResponse<TotalToken>>, next: NextFunction) => {
  try {
    logger.info({ avnTotalTokenRequest: req.body });
    const result = await avn.getTotalToken(req.body.token);
    res.status(200).send({ data: { total: result } });
  } catch (err) {
    next(err);
  }
});

app.post('/avnNftContractAddresses', async (req: Request, res: Response<SuccessResponse<string>>, next: NextFunction) => {
  try {
...
app.post('/getNftInfo', async (req: Request, res: Response<SuccessResponse<NftInfo | null>>, next: NextFunction) => {
  try {
...
app.post('/getBatchInfo', async (req: Request, res: Response<SuccessResponse<BatchInfo | null>>, next: NextFunction) => {
  try {
...
app.post('/lowers', async (req: Request, res: Response<SuccessResponse<LowerData | undefined>>, next: NextFunction) => {
  try {
...
app.post('/gatewayUserInfo', async (req: Request, res: Response<SuccessResponse<GatewayUserInfo>>, next: NextFunction) => {
  try {
...
app.post('/getPayer', async (req: Request, res: Response<SuccessResponse<PayerInfo | undefined>>, next: NextFunction) => {
  try {
...
app.post('/isPayerTransaction', async (req: Request, res: Response<SuccessResponse<boolean>>, next: NextFunction) => {
  try {
...
app.post('/addNewTransactionStatus', async (req: Request, res: Response<SuccessResponse<null>>, next: NextFunction) => {
  try {
...
app.post('/setTransactionRefusedByPayerStatus', async (req: Request, res: Response<SuccessResponse<null>>, next: NextFunction) => {
  try {
...
app.post('/setTransactionFailedToBeSentStatus', async (req: Request, res: Response<SuccessResponse<null>>, next: NextFunction) => {
  try {
...
app.post('/publishEvent', async (req: Request, res: Response<SuccessResponse<null>>, next: NextFunction) => {
  try {

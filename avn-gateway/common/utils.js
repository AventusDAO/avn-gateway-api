...
function errorResponse(rpcError, gatewayError, errorData, request, id) {
  const e = new Error()
  ...
  console.error(gatewayError.toUpperCase(), 'Ref:', ref, 'ID:', id, 'Error data:', JSON.stringify(errorData))

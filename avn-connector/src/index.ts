...
app.get('/health', async (req: Request, res: Response<null>, next: NextFunction) => {
  try {
...
app.post('/avnQuery', async (req: Request, res: Response<string>, next: NextFunction) => {
  try {
...
app.post('/avnPoll', async (req: Request, res: Response<PollResult | TxNotFoundResult | PollErrorResult>, next: NextFunction) => {
  try {
...
app.get('/pendingTransactions', async (req: Request, res: Response<string[]>, next: NextFunction) => {
  try {
...
app.post('/resolvePendingTransactions', async (req: Request, res: Response<null>, next: NextFunction) => {
  try {
...
app.post('/relayerFees', async (req: Request, res: Response<string | Record<string, string>>, next: NextFunction) => {
  try {
...
app.post('/avnAccountInfo', async (req: Request, res: Response<AccountInfo>, next: NextFunction) => {
  try {
...
app.post('/avnValidatorsToNominate', async (req: Request, res: Response<string>, next: NextFunction) => {
  try {
...
app.post('/avnStakingStats', async (req: Request, res: Response<string>, next: NextFunction) => {
  try {
...
app.post('/avnChainInfo', async (req: Request, res: Response<string>, next: NextFunction) => {
  try {
...
app.post('/avnCurrentBlock', async (req: Request, res: Response<string>, next: NextFunction) => {
  try {
...
app.post('/getDefaultRelayer', async (req: Request, res: Response<string>, next: NextFunction) => {
  try {
...
app.get('/unprocessedLifts', async (req: Request, res: Response<UnprocessedLifts>, next: NextFunction) => {
  try {
...
app.get('/autolower', async (req: Request, res: Response<string>, next: NextFunction) => {
  try {
...
app.post('/ethereumEventStatus', async (req: Request, res: Response<EthereumEventStatus>, next: NextFunction) => {
  try {
...
app.post('/avnTotalToken', async (req: Request, res: Response<TotalToken>, next: NextFunction) => {
  try {
...
app.post('/avnNftContractAddresses', async (req: Request, res: Response<string>, next: NextFunction) => {
  try {
...
app.post('/getNftInfo', async (req: Request, res: Response<NftInfo | null>, next: NextFunction) => {
  try {
...
app.post('/getBatchInfo', async (req: Request, res: Response<BatchInfo | null>, next: NextFunction) => {
  try {
...
app.post('/lowers', async (req: Request, res: Response<LowerData | undefined>, next: NextFunction) => {
  try {
...
app.post('/gatewayUserInfo', async (req: Request, res: Response<GatewayUserInfo>, next: NextFunction) => {
  try {
...
app.post('/getPayer', async (req: Request, res: Response<PayerInfo | undefined>, next: NextFunction) => {
  try {
...
app.post('/isPayerTransaction', async (req: Request, res: Response<boolean>, next: NextFunction) => {
  try {
...
app.post('/addNewTransactionStatus', async (req: Request, res: Response<null>, next: NextFunction) => {
  try {
...
app.post('/setTransactionRefusedByPayerStatus', async (req: Request, res: Response<null>, next: NextFunction) => {
  try {
...
app.post('/setTransactionFailedToBeSentStatus', async (req: Request, res: Response<null>, next: NextFunction) => {
  try {
...
app.post('/publishEvent', async (req: Request, res: Response<null>, next: NextFunction) => {
  try {

...
module "gateway_cognito" {
  ...
  callback_urls          = ["https://admin-gateway-external.dev.aventus.io/payerAdmin", "http://localhost:3007/payerAdmin"]
  logout_urls            = ["https://admin-gateway-external.dev.aventus.io/payerLogout", "http://localhost:3007/payerLogout"]

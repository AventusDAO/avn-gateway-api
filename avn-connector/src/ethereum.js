...
async function transactionExists(txHash) {
  console.log("XXXXXXXXXXXXXXXXXXXXXXXXXXX", txHash)
  console.log("XXXXXXXXXXXXXXXXXXXXXXXXXXX", `${ETHERSCAN_URL}module=transaction&action=gettxreceiptstatus&txhash=${txHash}&apikey=${ETHERSCAN_KEY}`)

...
describe('Prediction Market tests', async () => {
  ...
  describe('Create market and deploy pool', function () {
    ...
    describe('succeeds if', async function () {
      it('Request is processed', async function () {
        ...
        marketId = (await api.query.getPredictionMarketCounter() - 1);
      });
  ...
  describe('Transfer PM tokens', function () {
    ...
    before(async () => {
      senderBalanceBefore = new BN((await api.query.getPredictionMarketTokenBalance(user.address, { ForeignAsset: 0 })).free);
      receiverBalanceBefore = new BN((await api.query.getPredictionMarketTokenBalance(otherUser.address, { ForeignAsset: 0 })).free);
    ...
    describe('succeeds if', function () {
      it('Request is processed', async function () {
        ...
        senderBalanceAfter = new BN((await api.query.getPredictionMarketTokenBalance(user.address, { ForeignAsset: 0 })).free);
        receiverBalanceAfter = new BN((await api.query.getPredictionMarketTokenBalance(otherUser.address, { ForeignAsset: 0 })).free);
      });
  ...
  describe('Buy tokens via hybrid router', function () {
    ...
    before(async () => {
      ...
      winnerTokenBalanceBefore = new BN((await api.query.getPredictionMarketTokenBalance(user.address, { CategoricalOutcome: [marketId, winningChoice] })).free);
      loserTokenBalanceBefore = new BN((await api.query.getPredictionMarketTokenBalance(otherUser.address, { CategoricalOutcome: [marketId, losingChoice] })).free);
    ...
    describe('succeeds if', function () {
      it('Requests are processed', async function () {
        ...
        winnerTokenBalanceAfter = new BN((await api.query.getPredictionMarketTokenBalance(user.address, { CategoricalOutcome: [marketId, winningChoice] })).free);
        loserTokenBalanceAfter = new BN((await api.query.getPredictionMarketTokenBalance(otherUser.address, { CategoricalOutcome: [marketId, losingChoice] })).free);
      });
  ...
  describe('Sell tokens via hybrid router', function () {
    ...
    before(async () => {
      ...
      outcomeTokenBalanceBefore = new BN((await api.query.getPredictionMarketTokenBalance(otherUser.address, { CategoricalOutcome: [marketId, losingChoice] })).free);
      foreignAssetBalanceBefore = new BN((await api.query.getPredictionMarketTokenBalance(otherUser.address, { ForeignAsset: 0 })).free);
    ...
    describe('succeeds if', function () {
      it('Requests are processed', async function () {
        ...
        outcomeTokenBalanceAfter = new BN((await api.query.getPredictionMarketTokenBalance(otherUser.address, { CategoricalOutcome: [marketId, losingChoice] })).free);
        foreignAssetBalanceAfter = new BN((await api.query.getPredictionMarketTokenBalance(otherUser.address, { ForeignAsset: 0 })).free);
      });
  ...
  describe('redeemShares', function () {
    ...
    before(async () => {
      ...
      loserBalanceBefore = new BN((await api.query.getPredictionMarketTokenBalance(otherUser.address, { ForeignAsset: 0 })).free);
